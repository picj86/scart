...
public class OfferSummary {
	...
	public String toString() {
		...
		builder.append("OfferSummary [lowestNewPrice=").append(lowestNewPrice).append(", lowestUsedPrice=")
				.append(lowestUsedPrice).append(", lowestCollectiblePrice=").append(lowestCollectiblePrice)
				.append(", totalNew=").append(totalNew).append(", totalUsed=").append(totalUsed)
				.append(", totalCollectible=").append(totalCollectible).append(", totalRefurbished=")
				.append(totalRefurbished).append("]");
