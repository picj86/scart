...
public abstract class DataParser {
	 ...
	 *             with different error codes explained.
	 */
	public String queryService(String urlString) throws AffiliateAPIException {
		...
		try {
			...
			case HttpURLConnection.HTTP_FORBIDDEN:
				...
				// value.
				throw new AffiliateAPIException(
						"Tampered URL - The URL contents are modified from the originally returned value");
	...
	/***
	 * It gets the API Directory information (A list of categories and the
	 * corresponding URLs) from the API service and stores it locally.
	 * 
	...
	public abstract List<ProductInfo> getProductListByCategoy(String categoryqueryUrl) throws AffiliateAPIException;
	
	public abstract List<ProductInfo> getProductListById(String ProductsId) throws AffiliateAPIException;
