...
public class Price {
	...
	public String toString() {
		...
		builder.append("Price [amount=").append(amount).append(", bdAmount=").append(bdAmount).append(", currencyCode=")
				.append(currencyCode).append(", formattedPrice=").append(formattedPrice).append("]");
